    ...
    programs.plasma = {
      ...
      configFile = {
        ...
        "kwinrc" = {
          ...
          "Desktops"."Rows" = 1;
          "Tiling"."padding" = 4;
          "Tiling/221d553c-9248-5af3-bc6a-f903ece85bd5"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          "Tiling/2ac20889-2ffe-5be7-9f82-671d80d0b6d7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          "Tiling/63778347-f66a-5bb1-836c-0160bb0eba65"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          "Tiling/856e82be-9c6c-5a56-91d7-2e88fdb4e584"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          "Tiling/b139d5e7-0994-57d9-b378-1e6f13020bc3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          "Tiling/c8a4a66d-bbca-5e7f-8a37-ce3b4a705568"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
          "Xwayland"."Scale" = 1.75;
        };
        "plasma-localerc" = {
