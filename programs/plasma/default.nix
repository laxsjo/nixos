  ...
  config = {
    programs.plasma = {
      ...
      configFile = {
        ...
        "dolphinrc"."General"."ViewPropsTimestamp" = "2024,8,24,13,15,27.405";
        ...
        "kactivitymanagerdrc"."activities"."dad1e87e-84fb-4f4e-aa0f-cb086bfb65a6" = "Default";
        "kactivitymanagerdrc"."main"."currentActivity" = "dad1e87e-84fb-4f4e-aa0f-cb086bfb65a6";
        "kcminputrc"."Libinput/0/0/DP-3"."PointerAcceleration" = 0.000;
        "kcminputrc"."Libinput/1133/45108/Logitech MX Master 3S"."PointerAcceleration" = "-0.800";
        "kcminputrc"."Libinput/1133/50509/Logitech USB Receiver"."PointerAcceleration" = "-1.000";
        "kcminputrc"."Libinput/1133/50509/Logitech USB Receiver"."ScrollFactor" = 1.5;
        "kcminputrc"."Libinput/12951/6505/ZSA Technology Labs Moonlander Mark I"."PointerAcceleration" = 0.000;
        "kcminputrc"."Libinput/12972/24/Framework Laptop 16 Keyboard Module - ISO Consumer Control"."ScrollFactor" = 0.1;
        "kcminputrc"."Libinput/2362/628/PIXA3854:00 093A:0274 Mouse"."PointerAcceleration" = 0.000;
        "kcminputrc"."Libinput/2362/628/PIXA3854:00 093A:0274 Touchpad"."Enabled" = true;
        "kcminputrc"."Libinput/2362/628/PIXA3854:00 093A:0274 Touchpad"."ScrollFactor" = 0.5;
        "kded5rc"."Module-browserintegrationreminder"."autoload" = false;
        "kded5rc"."Module-device_automounter"."autoload" = false;
        "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "818,574";
        ...
        "kwinrc"."Desktops"."Id_1" = "012e596c-77fb-4e52-915e-e18b3f10b2cb";
        "kwinrc"."Desktops"."Number" = 1;
        "kwinrc"."Desktops"."Rows" = 1;
        "kwinrc"."Tiling"."padding" = 4;
        "kwinrc"."Tiling/221d553c-9248-5af3-bc6a-f903ece85bd5"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/2ac20889-2ffe-5be7-9f82-671d80d0b6d7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/63778347-f66a-5bb1-836c-0160bb0eba65"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/856e82be-9c6c-5a56-91d7-2e88fdb4e584"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
